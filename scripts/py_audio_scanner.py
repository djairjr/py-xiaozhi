...
def detect_audio_devices():
    ...
    for i, dev_info in enumerate(devices):
        ...
        # Identify input device (microphone)
    ...
    if recommended_mic:
        print("#Microphone initialization code"e initialization code")
    ...
    if recommended_speaker:
        print("\n# Speaker initialization code"nitialization code")
        print(
